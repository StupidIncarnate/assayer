 ...
 *   and start line), or `unresolved` for anything the single-file parse cannot see, which for now
 *   includes every import. Following resolves the link; it does not inline the callee.
 *
...
import { guardStepContract, lineNumberContract, representativeValueContract, symbolNameContract } from '@assayer/shared/contracts';
