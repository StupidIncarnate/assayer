...
const source = readFileSync(join(__dirname, 'undriven-welded-arg.ts'), 'utf8');
const relPath = 'src/sad-path/undriven-welded-arg.ts';
...
describe('sad-path / undriven-welded-arg — a private reached only through a welded literal argument', () => {
